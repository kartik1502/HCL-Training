...
public class StudentServiceImplementation implements StudentService {
    ...
    public int getTotalAge() {
        return repository.totalAge();
    }

    @Override
	public List<Student> getAllStudentAdmissionBetween(String startDate, String endDate) {
		return repository.findStudentByAdmissionDateBetween(Date.valueOf(startDate), Date.valueOf(endDate));
	}

	@Override
	public List<Student> getStudentNameNotNull() {
		return repository.findByStudentNameNotNull();
	}

	@Override
	public int getStudentAgeCount(int age) {
		return repository.getStudentAgeCount(age);
	}
