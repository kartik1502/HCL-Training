...
public class StudentController {
    ...
    @GetMapping("/getTotalAge")
    public int getTotalAge(){
        return service.getTotalAge();
    }

    @GetMapping("/getStudentAdmissionBetween")
    public List<Student> getStudentAdmissionBetween(@RequestParam String startDate,@RequestParam String endDate){
    	return service.getAllStudentAdmissionBetween(startDate, endDate);
    }

    @GetMapping("/getStudentNotNull")
    public List<Student> getStundetAgeNotNull(){
        return service.getStudentNameNotNull();
    }
    
    @GetMapping("/getStudentAgeCount")
    public int getStudentAgeCount(@RequestParam int age) {
    	return service.getStudentAgeCount(age);
    }
    ...
    @GetMapping("/getOldestStudent")
    public int getOldestStudent() {
    	return service.getOldestStudent();
    }

    @GetMapping("/getYoungestStudent")
    public int getYoungestStudent() {
    	return service.getYoungestStudent();
    }
    
    @GetMapping("/getStudentOrderByAgeAndName")
    public List<Student> getStudentOrderByAgeAndName(){
    	return service.getStudentOrderByAgeAndName();
    }
}
